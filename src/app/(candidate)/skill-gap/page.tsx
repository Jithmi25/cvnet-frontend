      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">
            Deep dive into your market readiness
          </p>
        </div>
      </div>
        ...
        <div className="space-y-5">
          <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
            ...
            <p className="text-xs text-slate-400 mb-4">
              Bridge the gap by mastering AWS and System Design. We&apos;ve
              curated a personalized learning path for you.
            </p>
            <Link
              href="#"
              className="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm py-2.5 rounded-xl transition-colors mb-3"
            >
              Start Learning Path
            </Link>
      ...
      <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden">
                ...
                ({
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      <span className={`text-xs ${demandConfig[demand]}`}>
                        {demand}
                      </span>
                    </td>
        ...
        <div className="px-6 py-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
          ...
          <div className="flex gap-2">
            ...
            <button className="px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
              Next
            </button>
          </div>
        </div>
