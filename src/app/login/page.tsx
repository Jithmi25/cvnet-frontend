    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-500 text-sm mb-8">Log in to access your data analytics dashboard.</p>
      ...
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center px-12 relative overflow-hidden"
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <p className="text-blue-100 text-base leading-relaxed mb-8">
            Join CVNet to access powerful analytics, real-time insights, and advanced dashboarding tools tailored for your business needs.
          </p>
          <div className="grid grid-cols-2 gap-4 text-left">
            {[
              ...
              <div key={label} className="bg-white/10 rounded-xl px-4 py-4 backdrop-blur-sm border border-white/20">
